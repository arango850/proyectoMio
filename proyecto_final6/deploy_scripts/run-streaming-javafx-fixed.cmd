...
:: run-streaming-javafx-fixed.cmd [STREAM_HOST] [WORKER_ENDPOINTS_COMMA_SEP]
...
java --module-path "%JAVAFX_LIB%" --add-modules javafx.base,javafx.graphics,javafx.controls,javafx.fxml -jar "..\streaming\target\streaming-0.1.0-SNAPSHOT-shaded.jar" "%STREAMING_ENDPOINT%" "%WORKER_ENDPOINTS%"
endlocal
